...
#ifndef __ADI_LTC2980_CORE_H__
#define __ADI_LTC2980_CORE_H__
 ...
 * \param[out]  apiVersion          The API version. \ref adi_ltc2980_version_t.
 *
...
/**
 * \brief       Sets the amount of time, in milliseconds, that elapses after the power supply has been enabled until the LTC2980’s DAC \n
 ...
 * \param[out]  status                Pointer to variable that stores read back value \ref adi_ltc2980_fault_status_t
 ...
 * \param[out]  is_ltc2980            1: is LTC2980 0: is not LTC2980
 * 
 * \return      API_CMS_ERROR_OK    API Completed Successfully.
 * \return      < 0                 Failed. \ref adi_cms_error_e for details.
 */
