...
#ifndef __ADI_ADL6332_CORE_H__
#define __ADI_ADL6332_CORE_H__

#include "adi_adl6332_core_types.h"
...
/**
 * \brief Initialize the ADL6332
 *
 * \param[in] adl6332    [context variable] Reference to the device.
 * \param[in] chip_id                       Target chip \ref adi_adl6332_chip_id_e
 * \param[in] config                        Configuration structure \ref adi_adl6332_init_t
 *
 * \return API_CMS_ERROR_OK                     API Completed Successfully
 * \return <0                                   Failed. \ref adi_cms_error_e for details.
 */
 ...
 * \param[in] adl6332    [context variable] Reference to the device.
 * \param[in] chip_id                       Target chip \ref adi_adl6332_chip_id_e
 * \param[in] muxout                        Configuration structure \ref adi_adl6332_muxout_e
 *
 * \return API_CMS_ERROR_OK                     API Completed Successfully
 * \return <0                                   Failed. \ref adi_cms_error_e for details.
 */
 ...
 *
 * \param[in] adl6332 [context variable]        Pointer to the device structure
 * \param[in] chip_id                           Target chip \ref adi_adl6332_chip_id_e
